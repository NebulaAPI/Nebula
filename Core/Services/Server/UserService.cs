...
namespace Nebula.Core.Services.Server
{
    public interface IUserService
    {
        ...
        Task<User> VerifyApiKey(string publicKey, string privateKey);
        UserApiKey GenerateApiKeys(Guid id);
    ...
    {
        private NebulaContext _context;
        ...
        public async Task<User> VerifyApiKey(string publicKey, string privateKey)
        {
            var key = _context.ApiKeys.Include(k => k.User).SingleOrDefault(
                k => k.PublicKey == publicKey 
                && k.PrivateKey == privateKey 
                && k.Active);
            
            return await Task.Run(() => key.User);
        }
