...
namespace Nebula.SDK.Util
{
    public class ConsoleTable
    {
        ...
        public void Write(Format format = Nebula.SDK.Util.Format.Default)
        {
            switch (format)
            {
                case Nebula.SDK.Util.Format.Default:
                    Console.WriteLine(ToString());
                    break;
                case Nebula.SDK.Util.Format.MarkDown:
                    Console.WriteLine(ToMarkDownString());
                    break;
                case Nebula.SDK.Util.Format.Alternative:
                    Console.WriteLine(ToStringAlternative());
                    break;
                case Nebula.SDK.Util.Format.Minimal:
